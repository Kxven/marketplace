...
import dio.marktplace.registration.domain.Customer;
import dio.marktplace.registration.domain.CustomerId;
import dio.marktplace.registration.domain.CustomerRepository;
...
public class JpaCustomerRepository implements CustomerRepository {
    ...
    private static dio.marktplace.registration.infrastructure.persistence.entity.Customer mapper(Customer customer){
        var entity = new dio.marktplace.registration.infrastructure.persistence.entity.Customer();
    ...
    private static Customer mapper(dio.marktplace.registration.infrastructure.persistence.entity.Customer entity){
